...
export default async function AdminPage() {
  ...
  try {
    ...
    const [r, n] = await Promise.all([
      db.rpc("pc_admin_roster", { p_token: TOKEN }),
      db.rpc("pc_admin_all_notes", { p_token: TOKEN }),
    ]);
    ...
    <main className="min-h-screen bg-[#fafafa] px-4 py-8 text-[#18181b]">
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex items-end justify-between">
          <div>
            <div className="text-xs font-bold tracking-widest text-accent">MFTEL-PC · 상변화열전달 · ADMIN</div>
