...
const WEEKS = [
  {
    id: 1,
    ko: { title: "비등 열역학·핵생성", sub: "비등곡선·계면 열역학·핵생성 이론" },
    en: { title: "Boiling Thermodynamics & Nucleation", sub: "Boiling curve · interfacial thermo · nucleation" },
  },
  {
    id: 2,
    ko: { title: "핵비등 메커니즘·상관식", sub: "기포 동역학·Rohsenow·환산압력 상관식" },
    en: { title: "Nucleate Boiling & Correlations", sub: "Bubble dynamics · Rohsenow · reduced-pressure" },
  },
  {
    id: 3,
    ko: { title: "비등 위기: CHF·막비등", sub: "유체역학 불안정성·Zuber·Bromley" },
    en: { title: "Boiling Crisis: CHF & Film Boiling", sub: "Hydrodynamic instability · Zuber · Bromley" },
  },
  {
    id: 4,
    ko: { title: "유동비등·과냉비등", sub: "유동양식·Chen·미세유로·이상유동 불안정성" },
    en: { title: "Flow & Subcooled Boiling", sub: "Flow patterns · Chen · microchannels · instability" },
  },
];

const T = {
  ko: {
    eyebrow: "MFTEL 대학원 · 2026",
    h1a: "상변화",
    h1b: "열전달",
    tagline1: "단상 대류가 못 하는 일을, 끓는 거품 하나가 해낸다.",
    tagline2: "비등과 액–기 상변화를 직관과 수식으로, 한 화면씩.",
    ctaEnter: "1주차 입장",
    ctaCurr: "전체 커리큘럼",
    ...
    instrBio:
      "다상유동 및 열공학 연구실(MFTEL)을 이끌고 있으며, 비등 열전달, 임계열유속(CHF) 증강, 열에너지 저장, 원자로 열수력 안전 등을 연구하고 있습니다.",
    ...
    footer: "2026 · MFTEL 대학원 · 상변화열전달 · 인하대학교",
    profView: "교수 열람",
  },
  en: {
    eyebrow: "MFTEL GRADUATE · 2026",
    h1a: "Phase-Change",
    h1b: "Heat Transfer",
    tagline1: "One boiling bubble carries what single-phase convection cannot.",
    tagline2: "Boiling and liquid–vapor phase change — intuition and equations, one screen at a time.",
    ctaEnter: "Enter Week 1",
    ...
    instrBio:
      "Leads the Multiphase Flow & Thermal Engineering Lab (MFTEL), researching boiling heat transfer, CHF enhancement, thermal energy storage, and nuclear reactor thermal-hydraulic safety.",
    curEyebrow: "CURRICULUM",
    curH: "4-Week Graduate Curriculum",
    ...
    footer: "2026 · MFTEL Graduate · Phase-Change Heat Transfer · Inha University",
